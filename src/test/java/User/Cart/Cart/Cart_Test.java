...
public class Cart_Test extends Base_Test {
    ...
    private static final String DATA_SHEET = "SCart";
    ...
    public void testSCart(String result, String title, String link, String description, String testType,
        ...
        try {
            ...
            String screenshotPath = ScreenShotUtil.captureScreenshot(Driver_Manager.getDriver(), "testSCart_Exception", "CartTest");
