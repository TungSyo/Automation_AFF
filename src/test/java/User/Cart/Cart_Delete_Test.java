        ...
        try {
            ...
            for (int i = 1; i < rowCount; i++) {
                ...
                switch (action.toLowerCase()) {
                    ...
                    case "verifynotion":
                        baseAction.handleVerification(cartDeleteActions.verifyNotion(result), "thông báo", result);
                        break;

                    case "verifytitle":
                        baseAction.handleVerification(cartDeleteActions.verifyTitle(title), "tiêu đề", title);
                        break;

                    case "verifylink":
                        baseAction.handleVerification(cartDeleteActions.verifyLink(link), "link", link);
                        break;
                    case "close":
