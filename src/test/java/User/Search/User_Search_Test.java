        ...
        try {
            ...
            for (int i = 1; i < rowCount; i++) {
                ...
                switch (action.toLowerCase()) {
                    ...
                    case "verifynotion":
                        handleVerification(searchActions.verifyNotion(result), "thông báo", result);
                        break;

                    case "verifytitle":
                        handleVerification(searchActions.verifyTitle(title), "tiêu đề", title);
                        break;

                    case "verifylink":
                        handleVerification(searchActions.verifyLink(link), "link", link);
                        break;
                    case "close":
